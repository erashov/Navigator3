CREATE view dbo.ml_frozen_report as
...
case when n in (1, 3) then null else (select signD2 from List2Nav ll where ll.NumML = t2.NumML) end as unfrozeDate
from
(
...
from ml_frozen_yesterday y join List2Nav l on l.NumML = y.NumML
