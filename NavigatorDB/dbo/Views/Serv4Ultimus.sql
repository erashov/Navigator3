...
SELECT     dbo.List2Nav.NumML, CASE ISNULL(I, '') WHEN '' THEN '' ELSE I + ' ' END + CASE ISNULL(E, '') WHEN '' THEN '' ELSE E + ' ' END + CASE ISNULL(S, 
                      ...
                      dbo.List2Nav.Sdan, dbo.List2Nav.Probl, dbo.List2Nav.Prim, Osnova.Manager, Osnova.Telefon, Osnova.Skorost, LTRIM(RTRIM(LTRIM(RTRIM(ISNULL(Osnova.Dop_A, '')))+' '+LTRIM(RTRIM(ISNULL(Osnova.Dop_B, ''))))) as Dop,
					  dbo.List2Nav.CR as NUM_REG, dbo.List2Nav.Sdan_ts as Sdan_ts
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Serv4Ultimus';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Serv4Ultimus';
