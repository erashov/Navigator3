CREATE PROCEDURE [dbo].[report_ML_77]
...
датой постановки задания УСП больше чем 5 дней, учесть  условие наличия заморозок МЛ 
если они попадают на период выполнения работ и с учетом их вычета выполняется условие больше чем 5 дней.
*/
