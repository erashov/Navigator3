...
create procedure [dbo].[report_ML_80_3]
	@start_date nvarchar(25),
	@end_date  nvarchar(25)
as

/*
		МЛ находящимся в работе ДЭЛС (УСП) за период       
*/
          select 
...
and
(
   ((List2Nav.c <= DATEADD(mi,1439,CONVERT(DATETIME,@end_date, 104))) and (List2Nav.c > CONVERT(DATETIME,@start_date, 104)))
     or
   ((List2Nav.b <= DATEADD(mi,1439,CONVERT(DATETIME,@end_date, 104))) and (List2Nav.b > CONVERT(DATETIME,@start_date, 104)))
)
