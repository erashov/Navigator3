CREATE PROCEDURE [dbo].[report_UIIAS_Delayed_More]
...
SELECT 
    ...
    where  
        cast(Round((case when (t1.all_time < t1.frozen)  then 0 
            else t1.all_time- t1.frozen end)/1440.0,2) as NUMERIC(15,2)) > @DaysCount1