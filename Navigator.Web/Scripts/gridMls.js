...
var columns = [
        ...
        { field: "oshugpz_ReportExist", title: "ГФЗ", filterable: filterEmpty, template: "#=oshugpz_start ? kendo.toString(oshugpz_start,'dd.MM.yyyy'):'' #<div class=\"valueDel\"></div>#=oshugpz_end ? kendo.toString(oshugpz_end,'dd.MM.yyyy'):'' # #=oshugpzIsCanceled ? oshugpzIsCanceled:'' #", width: 380 },
...
var fields = {
    ...
    StartDate: { type: "date" }, StopDate: { type: "date" }, test_date_a: { type: "date" }, test_date_b: { type: "date" }, Sroch_USHTU: { type: "boolean" }, Freeze_ReportExist: { type: "number" }
};
var selectedIds = {};
